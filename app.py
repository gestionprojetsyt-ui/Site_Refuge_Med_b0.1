...
with tab1:
    ...
    with col_refuge_2:
        ...
        st.markdown("""
            <a href="https://www.helloasso.com/associations/animaux-du-grand-dax/formulaires/2" target="_blank" class="btn-don-vert">
                <i class="fas fa-heart"></i> Faire un don (HelloAsso)
            </a>
            <a href="https://www.tookets.com/associations/association-les-animaux-du-grand-dax" target="_blank" class="btn-don-bleu">
                <i class="fas fa-coins"></i> Nous offrir vos Tookets
            </a>
...
# L'onglet urgence a besoin de ses colonnes définies pour col_u2
with tab_urgence:
